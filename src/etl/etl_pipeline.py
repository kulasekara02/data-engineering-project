...
class ETLPipeline:
    ...
    def _load(self, data):
        ...
        self._load_table(cursor, 'dim_customers', data['customers'],
                         ['customer_id', 'first_name', 'last_name', 'email', 'country', 'city', 'age_group', 'signup_date'])

        self._load_table(cursor, 'dim_products', data['products'],
                         ['product_id', 'product_name', 'category', 'subcategory', 'unit_price', 'cost_price'])

        self._load_table(cursor, 'dim_date', data['dates'],
                         ['date_id', 'full_date', 'year', 'quarter', 'month', 'month_name', 'week', 'day_of_week', 'day_name', 'is_weekend'])

        self._load_table(cursor, 'dim_channels', data['channels'],
                         ['channel_id', 'channel_name', 'channel_type'])

        self._load_table(cursor, 'fact_sales', data['sales'],
                         ['sale_id', 'customer_id', 'product_id', 'date_id', 'channel_id', 'quantity', 'unit_price', 'discount', 'total_amount', 'profit'])

        self._load_table(cursor, 'fact_user_activity', data['activities'],
                         ['activity_id', 'customer_id', 'date_id', 'channel_id', 'session_duration_sec', 'pages_viewed', 'actions_taken', 'bounce'])
