...
FIRST_NAMES = [
    ...
    'David', 'Elizabeth', 'William', 'Susan', 'Richard', 'Sarah', 'Joseph', 'Karen',
    'Thomas', 'Lisa', 'Charles', 'Nancy', 'Amal', 'Priya', 'Yuki', 'Chen',
    'Fatima', 'Omar', 'Sofia', 'Liam', 'Emma', 'Noah', 'Dasun', 'Kasun', 'Nimali'
]

LAST_NAMES = [
    'Smith', 'Johnson', 'Williams', 'Brown', 'Jones', 'Garcia', 'Miller', 'Davis',
    'Wilson', 'Anderson', 'Taylor', 'Thomas', 'Moore', 'Martin', 'Lee', 'White',
    'Kumar', 'Tanaka', 'Mueller', 'Silva', 'Perera', 'Fernando', 'Jayasuriya'
]

CATEGORIES = {
    'Electronics': {
        'subcategories': ['Laptops', 'Smartphones', 'Headphones', 'Tablets', 'Cameras'],
        'products': ['Pro Laptop', 'Ultra Phone', 'Wireless Earbuds', 'Tablet Air', 'DSLR Camera',
                     'Gaming Laptop', 'Budget Phone', 'Noise-Cancel Headphones', 'E-Reader', 'Action Camera']
    },
    'Clothing': {
        'subcategories': ['Shirts', 'Pants', 'Shoes', 'Jackets', 'Accessories'],
        'products': ['Cotton T-Shirt', 'Slim Jeans', 'Running Shoes', 'Winter Jacket', 'Leather Belt',
                     'Polo Shirt', 'Cargo Pants', 'Sneakers', 'Rain Coat', 'Sunglasses']
    },
    'Home & Garden': {
        'subcategories': ['Furniture', 'Kitchen', 'Decor', 'Tools', 'Lighting'],
        'products': ['Standing Desk', 'Blender Pro', 'Wall Art Set', 'Drill Kit', 'LED Floor Lamp',
                     'Bookshelf', 'Coffee Maker', 'Throw Pillows', 'Tool Box', 'Smart Bulbs']
    },
    'Books': {
        'subcategories': ['Fiction', 'Non-Fiction', 'Technical', 'Self-Help', 'Education'],
        'products': ['Python Mastery', 'Data Science Guide', 'SQL Cookbook', 'AI Revolution',
                     'Clean Code', 'Design Patterns', 'Machine Learning', 'Web Dev Handbook',
                     'Cloud Computing', 'DevOps Manual']
    },
    'Sports': {
        'subcategories': ['Fitness', 'Outdoor', 'Team Sports', 'Water Sports', 'Cycling'],
        'products': ['Yoga Mat', 'Hiking Backpack', 'Football', 'Swim Goggles', 'Mountain Bike',
                     'Dumbbells Set', 'Tent 4-Person', 'Basketball', 'Surfboard', 'Cycling Helmet']
    },
}
